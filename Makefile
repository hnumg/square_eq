...
-fsanitize=address,alignment,bool,bounds,enum,float-cast-overflow,integer-divide-by-zero,leak,nonnull-attribute,null,object-size,return,returns-nonnull-attribute,shift,signed-integer-overflow,undefined,unreachable,vla-bound,vptr


AllFiles= $(addprefix ./build/, $(addsuffix .o, $(basename $(wildcard *.cpp))))

main : ${AllFiles}
	@g++ ${CXXFLAGS} ${AllFiles} -o main
